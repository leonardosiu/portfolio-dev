        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start md:items-center relative z-10">
          ...
          <div className="md:col-span-5 w-full">
            <div className="flex flex-col gap-3">
              <Link href="#" className="group w-full text-left p-4 rounded-lg border border-gray-200 hover:border-indigo-500/30 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 ease-out cursor-pointer backdrop-blur-sm">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <MessageSquare className="w-4 h-4 text-gray-300 group-hover:text-indigo-500 transition-colors opacity-50 group-hover:opacity-100" />
                </div>
              </Link>
              <Link href="#" className="group w-full text-left p-4 rounded-lg border border-gray-200 hover:border-indigo-500/30 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 ease-out cursor-pointer backdrop-blur-sm">
                <div className="flex items-start justify-between gap-4">
